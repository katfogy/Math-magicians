...
**[MATH MAGICIANS]** This project is called Math-magicians. It is a wep app for performing basic math operations while generating random math quotes.
...
```sh
  cd my-folder
  git clone git@github.com:katfogy/math-magicians.git
```
-
...
Feel free to check the [issues page](https://github.com/katfogy/math-magicians/issues).
